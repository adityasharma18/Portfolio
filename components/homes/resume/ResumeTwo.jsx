...
// import { knoledges } from "@/data/knoledges"; // temporarily removed
// import { skillData } from "@/data/skills"; // temporarily removed
        ...
        <div className="mt-page-wrap pt-60 pl-80 pr-80">
          ...
          <div className="mt-resume-2">
            <div className="row">
              ...
              {/* Awards Section (Optional, commented out)
